...
const CreateProjectModal = ({ open, onCancel, onCreate }) => {
    ...
    const handleSubmit = async (values) => {
        ...
        try {
            ...
            try {
                const datasetSucess = await WaitForPollingSuccess(createdDataset.id);
                console.log('Dataset processing completed:', datasetSucess);
                const getedDatasetRes = await datasetAPI.getDataset(createdDataset.id);
