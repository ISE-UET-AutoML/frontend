...
const MultimodalPredict = (props) => {
	...
	return (
		<>
			{/* TITLE */}
			<h1 className="mb-5 text-4xl font-extrabold text-gray-900 text-left mt-2 flex">
				...
				<div className=" grid grid-cols-3 grid-rows-4 gap-4 w-5/6 ">
					<div className="col-span-2 row-span-4 shadow-xl p-4 rounded-lg">
						{selectedData && (
							<>
								<img
									src={selectedData.url_thumbnail}
									alt=""
									className="object-cover w-full h-[65%] rounded-md"
								/>
								<p className="text-left text-[#1904e5] font-semibold text-4xl text-transform: uppercase mt-4 mb-2">
									{
