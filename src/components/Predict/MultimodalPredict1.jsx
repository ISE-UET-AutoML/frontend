...
const MultimodalPredict1 = (props) => {
									...
									<div className="flex h-full w-full relative">
										...
										<div className="w-[50%] space-y-4 mt-[30px] ml-10">
											...
											<div className="justify-center items-center text-center pt-[20px] h-max">
												...
												<button
													className={` rounded-md px-6 py-2 font-medium  text-white w-fit transition-all shadow-[3px_3px_0px_black] hover:shadow-none hover:translate-x-[3px] hover:translate-y-[3px]
														${falsePredict.includes(selectedData.index) ? 'bg-emerald-400' : 'bg-red-500'}`}
													onClick={() => {
														if (
...
export default MultimodalPredict1
