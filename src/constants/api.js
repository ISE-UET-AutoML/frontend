...
export const API_URL = {
    ...
    get_project_previewdataset: (projectID) => `${API_BASE_URL}/projects/${projectID}/dataset_preview`,
    get_project_labelingdataset: (projectID) => `${API_BASE_URL}/projects/${projectID}/dataset_labeling`,
    update_label: (imageId) => `${API_BASE_URL}/images/${imageId}`,
    explain_instance: (projectID) => `${API_BASE_URL}/projects/${projectID}/explain`,
    create_label_for_dataset: (projectId) => `${API_BASE_URL}/projects/${projectId}/label_config`,
    update_annotation: (projectId, taskId) => `${API_BASE_URL}/projects/${projectId}/set_label/${taskId}`,
    ...
    predict_images: (experimentName) => `${API_BASE_URL}/experiments/predict/?experiment_name=${experimentName}`,
    get_dataset_preview: (projectID,page,pageSize) => `${API_BASE_URL}/projects/${projectID}/dataset_preview?&page=${page}&page_size=${pageSize}`,
}
