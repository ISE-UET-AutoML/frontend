...
const MultilabelTabularClassificationDemo = ({ metadata }) => {
	...
	const labelColumn = metadata?.modelInfo?.metadata?.label_column
	const predictedColumnName =
		Array.isArray(labelColumn) && labelColumn.length > 2
			? 'Predicted Class'
			: labelColumn || 'Predicted Class'
...
export default MultilabelTabularClassificationDemo
