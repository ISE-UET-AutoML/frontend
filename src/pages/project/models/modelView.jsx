								...
								>
									<Statistic
										title={
											...
											>{`Model ${metrics[0] ? toNormalCase(metrics[0]?.metric) : 'Null'} Score`}</span>
										}
								...
								<Col xs={24} sm={8}>
									<Alert
										...
										description={
											...
											>
												Instantly transform your trained
												model into a production-ready
								...
								<Col xs={24} sm={8}>
									<Alert
										...
										description={
											...
											>
												Securely export and preserve
												your model's learned parameters
												for future iterations or
												transfer learning.
											</span>
										}
										type="warning"
									...
									<Button
										...
										onClick={async (e) => {
											e.preventDefault()
											const urlResponse =
												await mlServiceAPI.getModelUrl(
													modelId
												)
									...
									<Alert
										...
										description={
											...
											>
												...
												model's performance by
												initiating a new training cycle
												with enhanced data or
												parameters.
											</span>
										}
										type="info"
														...
														value[0] !== null ? (
															...
															>
																<Table
																	...
																	rowClassName={() =>
																		''
																	} // removes Ant Design hover class
																	columns={Object.keys(
																		value[0]
																	).map(
																		(
