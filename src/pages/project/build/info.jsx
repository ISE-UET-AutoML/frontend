...
const ProjectInfo = () => {
    ...
    useEffect(() => {
        ...
        const fetchModel = async () => {
            try {
                const res = await modelServiceAPI.getModelByExperimentId(experimentId)
                if (res.status === 200) {
                    setModel(res.data)
                    ...
                    <div className="relative z-10 max-w-7xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            ...
                            <Button
                                ...
                                loading={
                                    !(modelDeploy === undefined || modelDeploy?.status === 'ONLINE')
                                }
                                onClick={
                                    hasTraining
                                ...
                                disabled={!(modelDeploy === undefined || modelDeploy?.status === 'ONLINE')}
                            >
                                <span
                                    style={{
                                        fontFamily: 'Poppins, sans-serif',
                                ...
                                >
                                    {hasTraining ? (
                                        ...
                                        >
                                            {modelDeploy?.status ? modelDeploy.status : 'Use Your Model'}
                                        </span>
                                    ) : (
                                        <span
