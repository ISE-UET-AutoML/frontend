		...
		try {
			...
			if (online) {
				...
				try {
					...
					if (
						visualizeResponse.status === 200 &&
						visualizeResponse.data.success
					) {
						...
						if (url && url.startsWith('http')) {
							...
							try {
								...
								// })
								console.log(
									'Project updated with deploy URL and duration:',
									url,
									selectedDuration
								)
								// setStreamlitUrl(url)
								...
								console.error(
									'Error updating project with deploy URL:',
									updateError
								)
							}
