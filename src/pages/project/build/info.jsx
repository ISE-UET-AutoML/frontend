...
`}</style>
        ...
        bg-gradient-to-br from-white/5 to-white/10 backdrop-blur-xl shadow-2xl"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                            ...
                            {/* Gen UI Button */}
                            <Card
                                className={`border border-gray-300 backdrop-blur-md shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 ease-in-out hover:opacity-90 relative group overflow-hidden rounded-xl font-poppins bg-gradient-to-br from-indigo-200 via-sky-200 to-pink-200 ${!isDeploymentChecked ||
                                        isGeneratingUI ||
                                        isCheckingUIStatus
                                        ? 'cursor-not-allowed'
                                        : 'cursor-pointer'
